...
const messages: Record<Locale, Dictionary> = {
  id: {
    ...
    "upload.model": "Model AI Vision",
    "upload.model.desc": "Pilih model untuk mengenali makanan",
  ...
  en: {
    ...
    "upload.model": "AI Vision Model",
    "upload.model.desc": "Select model for food vision detection",
