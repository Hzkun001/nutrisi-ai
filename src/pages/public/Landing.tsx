    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative pt-28 md:pt-36 pb-16 md:pb-20 px-4 overflow-hidden flex flex-col items-center justify-center min-h-[90vh]">
        ...
        <div className="container relative z-10 mx-auto max-w-5xl">
          ...
          >
            ...
            >
              Drop a photo of your meal and let our AI instantly break down the exact calories, protein, and macros for you. No more guessing.
            </motion.p>
          ...
          >
            ...
            <img src={heroImage} alt="FoodVision AI analyzing a food plate" className="w-full h-auto object-cover" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 px-4 relative">
        <div className="container mx-auto max-w-5xl">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 md:mb-4 text-gray-900">How it works</h2>
            <p className="text-gray-500 text-base md:text-lg">Three simple steps to understand your nutrition</p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-6">
            {[
              { step: "01", icon: Upload, title: "Upload a photo", desc: "Drag and drop or select an image from your gallery." },
              { step: "02", icon: Brain, title: "AI processing", desc: "Our vision model detects and isolates every food item." },
              { step: "03", icon: BarChart3, title: "Instant macros", desc: "Get an accurate estimate of calories, proteins, & fats." },
            ].map((item, i) => (
              <motion.div
                key={item.step}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-16 md:py-24 px-4 border-t border-gray-100 relative bg-gradient-to-b from-transparent to-gray-50/50">
        <div className="container mx-auto max-w-5xl">
          <motion.div
            ...
            className="text-center mb-10 md:mb-16"
          >
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 md:mb-4 text-gray-900">Features</h2>
            <p className="text-gray-500 text-base md:text-lg">The tools to master your daily intake</p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              { icon: Clock, title: "Scan History", desc: "Keep a complete log of all your scanned meals over time." },
              { icon: PieChart, title: "Visual Breakdown", desc: "Beautiful floating cards for easy nutritional understanding." },
            ].map((feature, i) => (
              <motion.div
                key={feature.title}
      ...
      >
        <div className="container mx-auto max-w-5xl">
          <motion.div
            ...
            className="text-center mb-10 md:mb-16"
          >
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 md:mb-4 text-gray-900">See it in action</h2>
            <p className="text-gray-500 text-base md:text-lg">Real-time mock food analysis results</p>
          </motion.div>
          ...
          <div className="grid items-start md:grid-cols-[minmax(0,1fr)_320px] lg:grid-cols-[minmax(0,1fr)_360px] gap-8 lg:gap-12">
            <motion.div style={{ y: previewScrollY }} className="space-y-6 md:pr-2 md:will-change-transform">
              <div className="p-5 sm:p-8 rounded-3xl bg-white border border-gray-100 shadow-sm">
                <h3 className="text-xs font-bold uppercase tracking-widest text-green-600 mb-5">Detected Labels</h3>
                <div className="flex flex-wrap gap-2">
                  {mockLabels.map((l, i) => <LabelBadge key={l} label={l} index={i} />)}
                </div>
              </div>
              <div className="p-5 sm:p-8 rounded-3xl bg-white border border-gray-100 shadow-sm">
                <h3 className="text-xs font-bold uppercase tracking-widest text-blue-600 mb-5">Food Items</h3>
                <div className="space-y-3">
                  {mockFoods.slice(0, 3).map((f, i) => <FoodResultCard key={f.input_name} food={f} index={i} />)}
                </div>
              </div>
            </motion.div>
            <div className="p-5 sm:p-8 rounded-3xl bg-white border border-gray-100 shadow-sm h-fit self-start md:sticky md:top-24">
              <h3 className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-6">Nutrition Summary</h3>
        ...
        <div className="container mx-auto max-w-2xl text-center relative z-10">
          ...
          >
            ...
            <p className="text-gray-500 text-base md:text-lg mb-6 md:mb-8">
              Start analyzing your meals with AI-powered nutrition estimates for free.
            </p>
            <Button asChild size="lg" className="rounded-full px-6 sm:px-10 h-12 sm:h-14 bg-gradient-to-r from-green-500 to-cyan-500 text-white font-bold text-sm sm:text-base shadow-lg transition-all hover:scale-105 hover:shadow-xl border-0 w-full sm:w-auto">
              <Link to="/scan">
                Start Upscaling Your Diet <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
          </motion.div>
        </div>
